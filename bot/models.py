...
class User(Base):
    ...
    org_last_billed_usage_bytes = Column(BigInteger, default=0)
    org_wallet_negative_limit = Column(Integer, default=0)
    org_negative_alert_sent = Column(Boolean, default=False)
